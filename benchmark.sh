...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer SF2NpzwJDImgjMJdtGIwBOB6uno6bao8' http://bankproj.southcentralus.inference.ml.azure.com/score
